...
const modals = readFileSync(resolve(componentsDir, 'modals.css'), 'utf8');
  ...
  it('should have component classes defined', () => {
    ...
    expect(selectors).toContain('.ease-glass-panel');
  });
