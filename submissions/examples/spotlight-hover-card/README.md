...
1. Include `components/cards.css` or `easemotion.css` in your project.
2. Add the `.ease-spotlight-card` class to any card container:
...
- `--ease-spotlight-size`: Control radial radius size (default `300px`).
